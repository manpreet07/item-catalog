...
def fbconnect():
    ...
    url = 'https://graph.facebook.com/v2.8/me?access_token=%s&fields=name,id,email' % t
    ...
    # Get user picture
    url = 'https://graph.facebook.com/v2.8/me/picture?access_token=%s&redirect=0&height=200&width=200' % t
    h = httplib2.Http()
    result = h.request(url, 'GET')[1]
    data = json.loads(result)
